...
xmobarCurrentWorkspaceColor = "#61AFEF"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), unsafeSpawn "source /home/alex/Scripts/dmenu_script.sh")
...
--
myLayout = avoidStruts $ spacing $ (tiled ||| Mirror tiled ||| Full)
  where
...
--
main = do
    xmproc <- spawnPipe "xmobar -x 1 /home/alex/.xmobarrc"
    ...
    xmonad $ ewmh $ defaults {
        ...
        , ppLayout = xmobarColor xmobarTitleColor ""
        , ppSep = " | "
